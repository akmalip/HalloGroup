...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Hallo Group — Creative Lifestyle Ecosystem", description: "Creative consulting firm and end-to-end holding company building a creative ecosystem across Indonesia." },
